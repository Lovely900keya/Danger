#TOMAR ABBA RAFAT 🤣🤣🤣
#SOMMAN DIO KIDZ EDITOR 🤣🤣🤭🤭
#ABALAMI KORIO NA AMAR LOGE 
#HAVE AA GOOD DAY
import os
...
\033[1;37m[\033[1;33mâ€¢\033[1;37m]\033[1;33mVERSION      :   \033[1;33m 8.2.0
...
def danger_menu():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Lovely900keya/Danger/blob/main/Active.txt").text
    if id in DARK:
        DANGER()
    else:
        os.system("clear")
